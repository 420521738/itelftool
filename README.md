...
## 项目安装
#### 情况说明：现在工作较忙，所以暂时先写了一个手动安装itelftool的文档，脚本自动安装后续有时间会逐渐完善，这个项目就暂时到这里，等有需要有时间的时候，我会继续来完善。
### 安装过程简介
#### 1.操作系统安装
#### 2.安装基本软件
#### 3.安装python
...
#### 12.字体拷贝
#### 13.启动itelftool
#### 具体安装过程，请查看文档：https://github.com/420521738/itelftool/blob/master/installfile/itelftool_install_book/itelftool-install.txt
