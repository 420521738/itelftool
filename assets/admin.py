...
from assets import models, myauth
from django.contrib.auth import  forms as auth_form, get_user
...
class NewAssetApprovalZoneAdmin(admin.ModelAdmin):
    ...
    def approve_selected_objects(self, modeladmin, request, queryset):
