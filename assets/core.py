...
class Asset(object):
    ...
    def __verify_field(self, data_set, field_key, data_type, required=True):
        ...
        if field_key == 'slot' and field_val == 0:
            try:
    ...
    def update_asset(self):
        #print('clean_data1111111111',self.clean_data)
        func = getattr(self, '_update_%s' % self.clean_data['asset_type'])
        #print('22222222222222222',self.clean_data['asset_type'])
        create_obj = func()
    ...
    def __compare_component(self, model_obj, fields_from_db, data_source):
        print('11111111---going to compare:[%s]' % model_obj, fields_from_db)
        print('22222222---source data:', data_source)
