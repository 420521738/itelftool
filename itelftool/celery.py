...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'itelftool.settings')
app = Celery('itelftool')
...
config.read(os.path.join('C:\\Users\\Administrator\\eclipse-workspace\\itelftool\\', 'adminset.conf'))
